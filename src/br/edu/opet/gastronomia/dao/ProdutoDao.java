...
public class ProdutoDao {
    ...
    public Produto create(Produto pProduto) {
        ...
        try {
           ...
           tObjeto.setId(tRsChave.getInt(1));
            ...
            ExceptionUtil.mostrarErro(tExcept, "Erro no mÈtodo de criacao do objeto");
        }
    ...
    public Produto recovery(long pProduto) {
        ...
        try {
            ...
            ExceptionUtil.mostrarErro(tExcept, "Erro no m√©todo de recuperaÁ„o do objeto");
        }
    ...
    public Produto update(Produto pProduto) {
        ...
        try {
            ...
            ExceptionUtil.mostrarErro(tExcept, "Erro no m√©todo de atualizaÁ„o do objeto");
        }
    ...
    public boolean delete(long pProduto) {
        try {
            ...
            ExceptionUtil.mostrarErro(tExcept, "Erro no m√©todo de remoÁ„o do objeto");
        }
    ...
    public List<Produto> search() {
        ...
        try {
            ...
            ExceptionUtil.mostrarErro(tExcept, "Erro no m√©todo de recuperaÁ„o da lista de objetos");
        }
